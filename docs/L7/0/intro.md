...
**➡ Voir la leçon complémentaire :** [Quelles sont les fonctions de l'art ?](../C/complement.md)
:::
...
| --- | --- | --- |
| <a href="/img/philo/rey.jpg" target="_blank" rel="noopener noreferrer"><img src={require('/img/philo/rey.jpg').default} alt="Description" width="100%" style={{maxWidth: "100%", height: "auto"}} /></a> | <a href="/img/philo/ben-cherche.webp" target="_blank" rel="noopener noreferrer"><img src={require('/img/philo/ben-cherche.webp').default} alt="Description" width="90%" style={{maxWidth: "100%", height: "auto"}} /></a> | <a href="/img/philo/beaubourg.jpg" target="_blank" rel="noopener noreferrer"><img src={require('/img/philo/beaubourg.jpg').default} alt="Description" width="100%" style={{maxWidth: "70%", height: "auto"}} /></a> |
