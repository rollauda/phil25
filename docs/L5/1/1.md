...
:::tip[définitions]
<div style={{textAlign: "left"}}><a href={useBaseUrl("/img/philo/fait-droit.png")} target="_blank" rel="noopener noreferrer"><img src={useBaseUrl("/img/philo/fait-droit.png")} width="500" alt="Image" /></a></div> 
:::

:::warning[Exercice]
<div style={{textAlign: "left"}}><a href={useBaseUrl("/img/philo/fait-droit-exo.png")} target="_blank" rel="noopener noreferrer"><img src={useBaseUrl("/img/philo/fait-droit-exo.png")} width="500" alt="Image" /></a></div>   
Appuyez-vous sur les [statistiques de l'**INSEE**](https://www.insee.fr/fr/statistiques/8381248) (Institut National de la Statistique et des Études Économiques) pour faire l'exercice.
:::


## Dichotomie de la liberté selon Leibniz
