...
- [Leçon 3](/docs/L3/accueil) : 
  - Comment pensent les sciences ? Quelles sont ses méthodes pour expliquer le réel ?
  - La science peut-elle expliquer la [**conscience**](/manuel/notions/conscience.md) ?
:::

:::warning[problématiques, Grandes thèses et arguments vue en cours]
- **[Leçon 3](/docs/L3/accueil). Comment les sciences construisent-t-elles leurs théories ? Comment établissent-elles leurs vérités ?** 
  - Une science cherche à répondre à la **question "comment ?"** en établissant des relations de cause à effet dans les phénomènes qu'elle veut expliquer. La causalité n'est pas une simple [**corrélation**](/docs/L3/1#corrélation-et-causalité) entre événements.
...
- **[Leçon 3](/docs/L3/accueil). La conscience peut-elle être expliquée scientifiquement ?** 
  - Si la [**conscience**](/manuel/notions/conscience.md) se réduit au cerveau, si elle n'est qu'un ensemble d'activités cérébrales, alors la science (la neurologie) peut l'expliquer en observant ce qu'il se passe dans le cerveau quand nous avons des états mentaux (pensées, désirs, perceptions, etc.). Les neurologues [**Nancy Kanwisher**](/docs/L3/1#conférence-ted-de-nancy-kanwisher) et [**Jean-Pierre Changeux**](/docs/L3/2#j-p-changeux--le-cerveau-explique-tous-les-comportements-humains) défendent cette thèse. 
  - Mais si la conscience est une expérience subjective (un "*film intérieur*") que l'on ne peut pas réduire à une simple activité cérébrale, alors l'explication de la conscience devient un [**"problème difficile" (David Chalmers**)](/docs/L3/1#conférence-ted-de-david-chalmers) que la science ne peut pas résoudre. La conscience serait donc une propriété émergente du cerveau, qui s'en distingue. [**Henri Bergson**](/docs/L3/2#h-bergson--il-y-a-plus-dans-la-conscience-que-dans-le-cerveau-qui-lui-correspond) défend l'idée que "*il y a infiniment plus, dans une conscience humaine, que dans le cerveau correspondant*".
    - Les sciences donnent une explication réductionniste et [**matérialiste**](/manuel/courants/matérialisme.md) de la conscience, à laquelle on peut opposer une [**théorie émergentiste**](/manuel/courants/emergentisme.md) de la conscience.
:::
