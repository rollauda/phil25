...
:::info[problématiques]
- [**Leçon 1, debat entre Socrate et Calliclés**](/docs/L1/2/2-1/2-1). Les normes morales et sociales s'opposent-elles à la liberté, nous empêchent-elles d'être libre ? Ou, au contraire, ces règles, en permettant l'égalité, rendent-elles tout le monde libre ? Être libre, est-ce donc faire tout ce que l'on veut, ou est-ce obéir à des lois qui sont les mêmes pour tous ?
:::

:::warning[Grandes thèses et arguments vue en cours]
- [**Calliclès**](/docs/L1/2/2-1/2-1), dans "Gorgias" de Platon, défend une **liberté naturelle** qui consiste à obéir à ce que la nature commande plutôt qu'aux conventions sociales. Être libre, c'est donc laisser libre cours à nos désirs, faire ce que la nature nous dit de vouloir.
- À l'inverse, [**Socrate**](/docs/L1/2/2-1/2-1), dans "Gorgias", voit la liberté comme la capacité à se limiter soi-même dans ses désirs, à se contenter raisonnablement de ce que nous possédons.
- [**Épictète**](/docs/L1/2/2-2/2-2-2/2-2-2), dans son "Manuel", défend une liberté intérieure qui consiste à : 
