...
:::
<iframe src="https://drive.google.com/file/d/1HIJ-oM1O04J6Z9y-OUlEp9gffkV7_I4f/preview" width="100%" style={{aspectRatio: "640/400"}} frameborder="0" allow="autoplay"></iframe>
...
## Repères conceptuels : nécessaire et contingent
  ...
  |---------------------|--------------------------|  
  | <div style={{textAlign: "center"}}><a href={useBaseUrl("/img/philo/l3exo1.png")} target="_blank" rel="noopener noreferrer"><img src={useBaseUrl("/img/philo/l3exo1.png")} width="350" alt="Image" /></a></div> | <div style={{textAlign: "center"}}><a href={useBaseUrl("/img/philo/l3exo2.png")} target="_blank" rel="noopener noreferrer"><img src={useBaseUrl("/img/philo/l3exo2.png")} width="350" alt="Image" /></a></div> |