...
:::  <a href={useBaseUrl('/img/philo/vrai-faux-reel-irreel.png')} target="_blank" rel="noopener noreferrer">
    <img
      src={useBaseUrl('/img/philo/vrai-faux-reel-irreel.png')}
      alt="Distinguer vrai, faux, réel et irréel"
      style={{width: '65%'}}
    />
  </a>
</div>
...
<iframe src="https://www.youtube.com/embed/VYEzdx0phWY?si=lsqD0tOn0JhvcEIf" width="100%" style={{aspectRatio: "560/315"}} frameborder="0" allowfullscreen allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"></iframe>

<iframe src="https://www.youtube.com/embed/bR_By2jEEcw?si=g1HM0jTDa34Lstwi" width="100%" style={{aspectRatio: "560/315"}} frameborder="0" allowfullscreen allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"></iframe>
:::
...
<div style={{textAlign: 'center'}}>
:::  <a href={useBaseUrl('/img/philo/trahison-images.png')} target="_blank" rel="noopener noreferrer">
    <img
      src={useBaseUrl('/img/philo/trahison-images.png')}
      alt="Distinguer vrai, faux, réel et irréel"
      style={{width: '65%'}}
    />
  </a>
...
<div style={{textAlign: 'center'}}>
:::  <a href={useBaseUrl('/img/philo/syllogisme.png')} target="_blank" rel="noopener noreferrer">
    <img
      src={useBaseUrl('/img/philo/syllogisme.png')}
      alt="syllogisme"
      style={{width: '200px'}}
    />
  </a>
...
:::important
DES VÉRITÉS NON-DÉMONTRÉES : VRAIES SUR LE FOND, MAIS INCOHÉRENTES, FAUSSES DANS LEUR RAISONNEMENT
